...
const Signup = () => {
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(135deg, #FEFEFE, #9BAAD7, #445FB4, #4444A3)",
      }}
    >
      {/* Background Circles */}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 rounded-md text-black focus:outline-none focus:ring-2 focus:ring-[#2D3D9B] focus:shadow-[0_0_8px_rgba(45,61,155,0.6)]"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-3 py-2 rounded-md text-black pr-10 focus:outline-none focus:ring-2 focus:ring-[#2D3D9B] focus:shadow-[0_0_8px_rgba(45,61,155,0.6)]"
                  required
                />
                <span
